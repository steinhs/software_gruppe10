...
class LeieAvParkeringTest {
    ...
    LeieAvParkering eheb14 = new LeieAvParkering(eivindhallan, eb14, new Leiedato(new Dato(16, 11, 2020), new Dato(16, 11, 2020)), new Leietid(new Tidspunkt(16, 40, 0), new Tidspunkt(17, 40, 0)), true);
    LeieAvParkering eheb14F = new LeieAvParkering(eivindhallan, eb14, new Leiedato(new Dato(16, 11, 2020), new Dato(16, 11, 2020)), new Leietid(new Tidspunkt(16, 40, 0), new Tidspunkt(17, 40, 0)), false);
    ...
    void get_og_set_tester() {
        ...
        eheb14.getLeietaker();
        eheb14.getLeietid();
        eheb14.getParkeringsplass();

        eheb14.setLeiedato(new Leiedato(new Dato(1,2,2021), new Dato(2,2,2021)));
        eheb14.setLeietaker(steinhanssen);
        eheb14.setLeietid(new Leietid(new Tidspunkt(17, 50,0), new Tidspunkt(16,40,0)));
        eheb14.setParkeringsplass(eb14);
    }
}